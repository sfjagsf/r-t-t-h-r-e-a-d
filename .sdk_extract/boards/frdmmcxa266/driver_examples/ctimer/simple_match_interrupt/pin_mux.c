...
- pin_list:
  ...
  - {pin_num: '85', peripheral: CTIMER2, signal: 'MATCH, 1', pin_signal: P3_19/LPUART4_TXD/CT2_MAT1/PWM0_X1/FLEXIO0_D27/PWM1_X1/LCD_P47/EZH_PIO19, slew_rate: fast,
    open_drain: disable, drive_strength: low, pull_select: down, pull_enable: disable, pull_value: low, input_buffer: enable, invert_input: normal}
 * BE CAREFUL MODIFYING THIS COMMENT - IT IS YAML SETTINGS FOR TOOLS ***********
 */
/* clang-format on */
...
void BOARD_InitPins(void)
{
    ...
    const port_pin_config_t port3_19_pin85_config = {/* Internal pull-up/down resistor is disabled */
                                                     .pullSelect = kPORT_PullDisable,
                                                     /* Low internal pull resistor value is selected. */
                                                     .pullValueSelect = kPORT_LowPullResistor,
                                                     /* Fast slew rate is configured */
                                                     ...
                                                     /* Pin Control Register fields [15:0] are not locked */
                                                     .lockRegister = kPORT_UnlockRegister};
    /* PORT3_19 (pin 85) is configured as CT2_MAT1 */
    PORT_SetPinConfig(PORT3, 19U, &port3_19_pin85_config);
}
/***********************************************************************************************************************
 * EOF
 **********************************************************************************************************************/
