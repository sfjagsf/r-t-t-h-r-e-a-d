...
#define HAL_UART_DMA_HANDLE_SIZE (UINTPTR_SIZE * 31U + HAL_UART_ADAPTER_LOWPOWER * UINTPTR_SIZE * 9U)
#elif (defined(FSL_FEATURE_SOC_EDMA_COUNT) && (FSL_FEATURE_SOC_EDMA_COUNT > 0U))
#define HAL_UART_DMA_HANDLE_SIZE (UINTPTR_SIZE * 62U + HAL_UART_ADAPTER_LOWPOWER * UINTPTR_SIZE * 9U)
#else
